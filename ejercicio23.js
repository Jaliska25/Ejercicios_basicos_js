...
console.log(
  'Películas cortas: ' + smallMovies.map((movies) => movies.name).join(', ')
)
console.log(
  'Películas medianas: ' + mediumMovies.map((movies) => movies.name).join(', ')
)
console.log(
  'Películas largas: ' + bigMovies.map((movies) => movies.name).join(', ')
)
